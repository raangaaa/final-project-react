...
const WatchlistView = ({ watchlists, isLoading, deleteWatchlistMovie }) => {
	return (
		<div>
			<div
				id="watchlist"
			...
			>
				<h1 className="text-4xl font-bold text-center">Watchlist Movie</h1>
					...
					{!isLoading
						? watchlists?.results?.map((item, index) => (
								...
								>
									...
									<button
										onClick={() => deleteWatchlistMovie(item.id)}
										type="button"
...
WatchlistView.propTypes = {
	...
	deleteWatchlistMovie: PropTypes.func.isRequired
};
