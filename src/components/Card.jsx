...
const Card = ({ data }) => {
	return (
		<div className="relative text-white cursor-pointer w-44 h-66 flex-shrink-0 overflow-hidden rounded-lg shadow-lg transform transition-all duration-300 hover:scale-105">
			{/* Poster film */}
			<img
			...
			<div className="absolute p-3 inset-0 flex flex-col gap-1 justify-end bg-black bg-opacity-0 group hover:bg-opacity-70 transition-opacity duration-300">
				<h3 className="text-base font-semibold opacity-0 group-hover:opacity-100 transition-opacity duration-300">
					{data.title}
				</h3>
				<p className="text-xs font-normal line-clamp-2 opacity-0 group-hover:opacity-100 transition-opacity duration-300">
					{data.overview}
				</p>
