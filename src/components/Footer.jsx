		...
		<>
			<footer className="footer dark:bg-megenta-200 bg-white dark:text-white text-gray-800 p-10">
				<nav>
					...
					<Link to={"/watch_list"} className="link link-hover">
						Watch List
					</Link>
				</nav>
				<nav>
					<h6 className="footer-title">External Links</h6>
					<Link to={"https://www.themoviedb.org/"} className="link link-hover">
						TMDB
					</Link>
					<Link to={"https://www.imdb.com/"} className="link link-hover">
						IMDB
					</Link>
				</nav>
				<nav>
